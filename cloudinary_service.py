...
MAX_IMAGE_DIMENSION = int(os.getenv("MAX_IMAGE_DIMENSION", 4096))  # Max width/height for images
ALLOWED_IMAGE_FORMATS = os.getenv("ALLOWED_IMAGE_FORMATS", "jpg,jpeg,png,webp,gif").split(",")
ALLOWED_DOCUMENT_FORMATS = os.getenv("ALLOWED_DOCUMENT_FORMATS", "pdf,doc,docx,txt").split(",")
ALLOWED_VIDEO_FORMATS = os.getenv("ALLOWED_VIDEO_FORMATS", "mp4,webm,mov").split(",")
COMPRESSION_QUALITY = int(os.getenv("COMPRESSION_QUALITY", 80))  # Default compression quality
